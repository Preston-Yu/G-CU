...
void provisioningLogUuid(const ProvisioningContext &ctx) {
  Serial.print("BLE UUID (v1): ");
  Serial.printf("%02X%02X%02X%02X-", ctx.uuid[0], ctx.uuid[1], ctx.uuid[2], ctx.uuid[3]);
  Serial.printf("%02X%02X-", ctx.uuid[4], ctx.uuid[5]);
  Serial.printf("%02X%02X-", ctx.uuid[6], ctx.uuid[7]);
  Serial.printf("%02X%02X-", ctx.uuid[8], ctx.uuid[9]);
